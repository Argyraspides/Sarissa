...
var ASM_CONSTS = {
 ...
 198684: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 198767: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 198836: () => { return window.innerWidth; },  
 198866: () => { return window.innerHeight; }
};
